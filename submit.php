<?php
  ...
  if(Token == $_POST['token'])
  {
   ...
   // $achieve1 = $_POST['achieve1'];
    ...
    array_push($achieve1,$_POST['achieve1']);
    ...
    if(isset($_POST['achieve2']) && !empty($_POST['achieve2']))
    {
        array_push($achieve1,$_POST['achieve2']);
    }
    if(isset($_POST['achieve3']) && !empty($_POST['achieve3']))
    {
        array_push($achieve1,$_POST['achieve3']);
    }
...
<div class="grid-container">
  ...
  <div class="zone-2">
    ...
    <div class="subTitle">
      <h1><?php echo ucwords($address);?><h1>
    </div>
    <div class="group-1">
      <div class="title">
        <div class="box">
      ...
      <div class="desc"><?php echo $obj;?></div>
    </div>
    <div class="group-2">
      <div class="title">
        <div class="box">
...
<div class="group-3">
      ...
      <div class="desc">
      <?php 
          for($i=0; $i<count($achieve1);$i++)
          {
            echo "<ul>
            <li>
              <div class='msg-1'><br></div>
              <div class='msg-2'>" . ucwords($achieve1[$i]) ."</div>
            </li>
          </ul>";
          }
        ?>
