    ...
    <div class="form-container">
        <form action="submit.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="border border-dark p-3 mb-3">    
                <h2>Skills (Max:5)</h2>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Technical & Soft Skills</label>
                    <input type="text" class="form-control" name="skill1" required>
                    <select class="form-select mt-2" name="skill_level1" required>
                        <option value="">Select stars based upon your level</option>
            ...
            <div class="border border-dark p-3 mb-3">    
                ...
                <div class="form-floating">
                    <textarea class="form-control" name="obj" style="height: 100px" required></textarea>
                </div>
            </div>
            <div class="border border-dark p-3 mb-3">    
            ...
            <div class="border border-dark p-3 mb-3">    
                <h2>Work Experience/Projects (Max:3)</h2>
                <div class="mb-3">
            ...
            <div class="border border-dark p-3 mb-3">    
                ...
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Title</label>
                    <input type="text" name="achieve1" class="form-control"></textarea>
                </div>
            </div>
